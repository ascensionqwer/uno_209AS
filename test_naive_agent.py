...
from src.uno.cards import RED, YELLOW, GREEN, BLUE, BLACK, WILD, WILD_DRAW_4
...
class TestNaiveAgent(unittest.TestCase):
    ...
    def test_wild_card_chooses_most_frequent_color(self):
        ...
        self.game.H_1 = [
            (RED, '1'), (RED, '3'), (RED, '5'),  # 3 red cards
            (BLUE, '2'), (BLUE, '4'),  # 2 blue cards
    ...
    def test_wild_draw_4_chooses_most_frequent_color(self):
        ...
        self.game.H_1 = [
            (GREEN, '1'), (GREEN, '3'), (GREEN, '5'), (GREEN, '7'),  # 4 green cards
    ...
    def test_ignores_wild_cards_for_color_counting(self):
        ...
        self.game.H_1 = [
            ('Black', WILD), ('Black', WILD_DRAW_4),  # Wild cards (should be ignored)
            ('Blue', '1'), ('Blue', '3'),  # 2 blue cards (should win)
            ('Red', '5'),  # 1 red card
        ]
    ...
    def test_player_2_hand_used_for_player_2(self):
        ...
        self.game.H_2 = [
            (YELLOW, '1'), (YELLOW, '3'), (YELLOW, '5'),  # 3 yellow cards
    ...
    def test_timing_is_recorded(self):
        ...
        from src.utils.game_runner import reset_naive_decision_stats, get_naive_decision_stats
