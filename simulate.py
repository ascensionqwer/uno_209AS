...
if __name__ == "__main__":
    # Naive vs Naive
    total_game = 1000
    print("Uno Naive vs Uno Naive Player Test\n")

    # Create players
    naive_player_1 = Uno_Naive(player_id=1)
    naive_player_2 = Uno_Naive(player_id=2)

    # Create game controller
    controller = GameController(naive_player_1, naive_player_2, verbose=False)
    ...
    # AI vs AI
    total_game = 1000
    print("Uno AI vs Naive Player Test\n")

    # Create players
    ai_player = Uno_AI(player_id=1, num_samples=500, lookahead=1)
    naive_player = Uno_Naive(player_id=2)

    # Create game controller
    controller = GameController(ai_player, naive_player, verbose=True)
